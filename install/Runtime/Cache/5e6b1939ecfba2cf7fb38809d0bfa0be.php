...
<div class="header">
    ...
    <div class="fr">
    	<ul class="top_nav fr">
        	<li><a href="http://www.138gzs.com/" target="_blank"><?php echo L('official_bbs');?></a></li>
            <li><a href="http://huameishumazhijia.taobao.com/" target="_blank"><?php echo L('user_manual');?></a></li>
        </ul>
