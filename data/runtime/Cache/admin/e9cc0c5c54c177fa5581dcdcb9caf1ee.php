...
</script><?php endif; ?><div style="display:none;"><script language="javascript" type="text/javascript" src="http://js.users.51.la/16598910.js"></script></div><script>    var collect_url = "<?php echo U('robots/item_checks');?>";
	var p = 1;
