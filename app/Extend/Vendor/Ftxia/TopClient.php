...
class TopClient
{
	...
	protected $sdkVersion = "top-sdk-php-20131001";
	...
	protected function logCommunicationError($apiName, $requestUrl, $errorCode, $responseTxt)
	{
		...
		$logger = new LtLogger;
		$logger->conf["log_file"] = LOG_PATH . "ftxia/top_comm_err_" . $this->appkey . "_" . date("Y-m-d") . ".log";
	...
	public function execute($request, $session = null)
	{
		...
		{
			$logger = new LtLogger;
			$logger->conf["log_file"] = FTX_DATA_PATH . "ftxia/top_biz_err_" . $this->appkey . "_" . date("Y-m-d") . ".log";
			$logger->log(array(
				date("Y-m-d H:i:s"),
				$resp
			));
